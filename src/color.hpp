#ifndef LFA_TEMA_2_COLOR_HPP
#define LFA_TEMA_2_COLOR_HPP

// https://gist.github.com/Ph0enixKM/5a0d48c440a6dd664d7ae4c807c53008
...
#include <windows.h>
inline void color(const std::string &color, const std::string &line, bool newLine = false) {
